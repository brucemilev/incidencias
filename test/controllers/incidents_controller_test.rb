...
class IncidentsControllerTest < ActionController::TestCase
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post :create, incident: { Descripcion: @incident.Descripcion, Evento: @incident.Evento, duracion: @incident.duracion, fecha: @incident.fecha }
    end
  ...
  test "should update incident" do
    patch :update, id: @incident, incident: { Descripcion: @incident.Descripcion, Evento: @incident.Evento, duracion: @incident.duracion, fecha: @incident.fecha }
    assert_redirected_to incident_path(assigns(:incident))
  end
